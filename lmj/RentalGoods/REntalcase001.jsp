...
<center>
	...
	<IMG SRC="/img/act_img/shim.gif" WIDTH="147" HEIGHT="1" alt=""><BR>
				<!-- ナビframe -->
	<NOLAYER>
	<IFRAME SRC="/lmj/navi.jsp" NAME="" WIDTH="147" HEIGHT="680" FRAMEBORDER="0" SCROLLING="NO"></IFRAME> 
	</NOLAYER> 
				<ILAYER SRC="/lmj/navi.jsp" WIDTH="147" HEIGHT="680"></ILAYER>
				<!-- /ナビframe -->
	</td>
			<!-- 調整 -->
			<td>
          ...
          <tr> 
            ...
            <td class="txt16b" valign="middle"> 
              <table border="0" cellspacing="0" cellpadding="0" width="531" align="center">
                <tr> 
                  <td class="txt16b">旅行関連商品　<span class="txt12">TRAVEL SUPPORT</span></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  <td class="b"> 
									 	<div align="left"><b>
								    <img src="/img/pont2.gif" width="10" height="10">　<A HREF="/travel/travel_top_1.html">海外旅行保険</a>　
										...
										<img src="/img/pont2.gif" width="10" height="10">　<A HREF="/travel/travel_handy.html">携帯電話レンタル</a>　<br/>
										<img src="/img/pont2.gif" width="10" height="10">　<span class="orgb">レンタルスーツケース</span>　
										<br/>
...
function calcSending(){
	...
	var sending = <%= Property.Sending_Price %>;
	var sending_tax = 0;
...
//-->
	...
	<table BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="548">
      	...
      	<table WIDTH="524" BORDER="0" CELLSPACING="0" CELLPADDING="0">
					<tr>
						<td VALIGN="TOP" colspan='3'>
							<span class='txt12'>
								...
								<% if(type_==2) { %>
									<li>伸縮自在なハンドルバー装備で持ち運びがとってもラクラク。
									<li>360度回転する中サイズは5輪キャスター付。小サイズは4輪キャスター付。
									(尚、小サイズでも機内持込ができない場合があります。）快適なフットワークで快適な旅を！
									<li>180度まで開くので、出し入れがとっても便利。
									<li>ハンガー1本付きです。
								<% } %>
							</span>
						</td>
					...
					<tr>
						<td>
							...
							<input type="hidden" name='agtcode' value='LMJR'/>
						...
						<tr>
							<td colspan='2'>
								<table border='0' cellspacing="1" cellpadding="1" width='100%'>
									...
									<input type='hidden' name='sub_productions' value='ドライヤー1000W Aタイプ Cプラグ付'/>
									<input type='hidden' name='sub_prices' value=''/>
									<tr>
										<td bgcolor="#FFFFFF" colspan='1' width='250'>・ドライヤー1000W Aタイプ Cプラグ付</td>
										<td bgcolor="#FFFFFF" >
									...
									<input type='hidden' name='sub_productions' value='ドライヤー コンパクト400 Bタイプ Cプラグ付'/>
									<input type='hidden' name='sub_prices' value=''/>
									<tr>
										<td bgcolor="#FFFFFF" colspan='1' nowrap>・ドライヤー コンパクト400W Bタイプ Cプラグ付</td>
										<td bgcolor="#FFFFFF">
										<select name='sub_numberOfgoods' onChange='javascript:viewPricesStr();'>
										<option value='0'>0</option>
										<option value='1'>1</option>
									...
									-->
									<input type='hidden' name='sub_productions' value='ドライヤー Cタイプ(カール) Cプラグ付'/>
									<input type='hidden' name='sub_prices' value=''/>
									<tr>
										<td bgcolor="#FFFFFF" colspan='1'>・ドライヤー Cタイプ(カール)　Cプラグ付</td>
										<td bgcolor="#FFFFFF">
										<select name='sub_numberOfgoods' onChange='javascript:viewPricesStr();'>
										<option value='0'>0</option>
										<option value='1'>1</option>
        ...
        <td VALIGN="TOP" height="124" align='right' width='200'>
            ...
            <tr>
            	<td colspan='2'>
              	<img SRC="/img/travel_img/<%= product_id.toLowerCase() %>.gif" WIDTH="200" HEIGHT="200" border='1'>
              </td>
            </tr>
            <tr>
                        		...
                        		<table border=0 cellspacing="0" cellpadding="0" width='100%'>
                        			<tr>
                        				...
                        				<td class='txt12' bgcolor='#FFFFFF'>
																	<font color='red'>
                        						お届けはご利用開始日の3日前、回収はご帰宅日の翌々日です。<br/>開始日から終了日までがレンタル期間となります。
																	</font>
																</td>
															</tr>
														</table>
                        	...
                        	<td>
                        		<table border=0 cellspacing="0" cellpadding="0" width='100%'>
                        			<tr>
                        				...
                        				<td class='txt12' bgcolor='#FFFFFF'>
																	<font color='red'>
                        						オプションにつきましては、単品の貸し出しはいたしません。他の商品と組み合わせてご利用ください。
																	</font>
																</td>
															</tr>
														</table>
...
var s_channel="RENTAL_SUITECASE"
var s_pageType=""
