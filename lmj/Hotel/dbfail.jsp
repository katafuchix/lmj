        ...
        <TABLE cellSpacing=0 cellPadding=0 width=438 border=0>
          <TR> 
            ...
            <TD class="txt16b" valign="middle"> 
              <table border="0" cellspacing="0" cellpadding="0" width="288" align="center">
                <tr> 
                  <td valign="bottom"><h3>国内ホテル・やど　<span class="txt12">DOMESTIC　HOTELS</span></td>
                </tr>
                <tr> 
                  <td height="5"><img src="/img/blk.gif" width="381" height="1"></td>
                </tr>
                <tr> 
                  <td class="b"> 
                    <div align="left"><b><img src="/img/pont2.gif" width="10" height="10"> 
                      ...
                      <a href="/lmj/Hotel/from_postalArea.jsp"> 地図より</a></b></div></h3>
                  </td>
                </tr>
              </table>
            </TD>
...
<!-- /移動 -->
			...
			<tr>
			<td width="15" VALIGN="TOP" CLASS="txt10" align="right">　</td>
			<td width="400" CLASS="txt14redb"><br/><br/><br/>ご指定の条件ではお部屋がございませんでした。<BR/>前のページに戻り、ご予約日・ご予約条件を<B>変更してみてください。<br/><br/><br/></td>
			</tr>
			</table>
			<br>
			<table BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="438">
