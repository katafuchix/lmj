...
<font class="txtcategory">
		|<a href='/lmj/Hotel/top.do?act=index'>おすすめホテル・宿</a>|
		|<a href='/lmj/Hotel/top.do?act=purpose'>地図より</a>|
		<!-- |<a href='/lmj/Hotel/top.do?act=areas'>おすすめはここ</a>| -->
</font>
		</h3></td>
		</tr>
		</table>
...
<!-- /移動 -->
			...
			<td width="400" CLASS="txt10">お問い合わせいただいた在室が、ございませんでした。申し訳ありませんが、お戻りになって再度、お選びいただけますか？</td>
			</tr>
			</table>
			<br>
			<table BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="438">
