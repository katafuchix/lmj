...
<tr>
<td VALIGN="TOP">
			<form  ACTION="/lmj/Restraunt/top.do" METHOD="POST">
			<table BORDER="0" CELLSPACING="0" CELLPADDING="2" ALIGN="CENTER">
			<tr>
			<td CLASS="txt12b" ALIGN="RIGHT">只今システムが大変混雑しております。<br/>しばらく経ってから再度アクセスしてください。</td>
			</tr>
			<tr>
			<td COLSPAN="2" ALIGN="center"><br>
			<input TYPE="image" src='/img/b_back.gif' width=56 height=20 border=0/>
			</td>
			</tr>
			</table>
			</form>
...
<!-------------- generated code end --------------->
	<tr>
		<td height="14"><img SRC="/img/res_img/line560.gif" WIDTH="438" HEIGHT="1" VSPACE="6" ALT=""></td>
	</tr>
	</table>
	</td>
	<td BGCOLOR="#666666"><img SRC="/img/res_img/shim.gif" WIDTH="1" HEIGHT="1" VSPACE="1" ALT=""></td>
