...
<table BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="438">
	<tr>
		<td BGCOLOR="#F3F0EA" WIDTH="440" colspan='2'>
			<span CLASS="super14">LMJÇ®Ç∑Ç∑Çﬂ<!--<xml:out select='$pageamount//title' />--></span><BR><BR>
		</td>
	</tr>
  <tr>
										...
										<table CELLPADDING="4" CELLSPACING="0" BORDER="0" WIDTH="100%" height="180">
											...
											<tr>
												<td ALIGN="left" BGCOLOR="#FFFFFF">
													<a HREF="search.do?scatid=<xml:out select='plan/scatid' />" CLASS="txt12b"><xml:out select='plan/title'/>ÅI</a>
												</td>
											</tr>
											<tr>
											...
											<tr>
												<td CLASS="b" ALIGN="RIGHT" BGCOLOR="#FFFFFF"><xml:out select='product/copy/pricestr' /> â~
												</td>
											</tr>
										</table>
									</td>
	...
	<xml:forEach select="$pageamount//products/list/production" >
		...
		<tr>
			...
			<td WIDTH="399" height="40">
				<a HREF="./detail.do?catid=<xml:out select='plan/catid'/>&product_id=<xml:out select='product/prod_id'/>">
				<span CLASS="b"><xml:out select='product/name' /></a>Å@
				<xml:out select='product/copy/pricestr' />â~</span><br>
				<span class="txt12"><xml:out select='product/copy/comment' /></span>
				<br><br>
				ÇªÇÃÇŸÇ©ÅA<a HREF="search.do?scatid=<xml:out select='plan/scatid' />" CLASS="txt12b"><xml:out select='plan/title'/>ÇÕÇ±ÇøÇÁ</a>Ç©ÇÁ
