...
public class CardAuthServlet extends HttpServlet implements CardAuth {
	...
	public void init(ServletConfig servletConfig) throws ServletException {
		...
		try {
			resources =
				ResourceBundle.getBundle("jp.co.lastminute.card.resources.CardAuth",Locale.getDefault());
	...
	public String cardCheck( String cardNumber,String cardExpiry,String order_num,int price){
	...
	private static String getRequestErr( PaymentRequestor requestor ) throws Exception {
		...
		sb.append( "支払区分            [" + requestor.getResPaymentDivision() + "]");
		...
		sb.append( "元取引支払区分      [" + requestor.getResDelPaymentDivision() + "]");
