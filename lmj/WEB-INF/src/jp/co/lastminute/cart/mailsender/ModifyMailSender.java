 ...
 */
public class ModifyMailSender implements Serializable {
	...
	private static String templateMailPath = Property.BASE_DIR + "/modify/";
	/** Creates new ConsumerMailSender */
	public ModifyMailSender() {
	}
	/**
	 * 	初期化
	 */
	public void init(
		...
		this.base_suborder = base_suborder;
