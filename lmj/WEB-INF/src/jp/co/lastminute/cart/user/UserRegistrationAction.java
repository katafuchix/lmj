...
/////////////////////////////////////////////
        ...
        if(email_form_check_frg == 0 && passwd_form_check_frg == 0){
            ...
            user_id = dut.checkUserRegist( e_mail )[0];
            if( dut.checkUserRegist( e_mail )[1] == 1 ){
                update_flg = true;
            }else{                
        ...
        if(error_sum == 0){
            ...
            if( update_flg ){
                ...
                db_success = dut.addUserTbl(ut, pf ); //UserTblの追加              
            }
			...
			if( db_success ){
	            ...
	            String maildata = "";
	            maildata += sei_kanji + " " + na_kanji + " 様！\n\n";
	            maildata += "ラストミニットの世界へようこそ！！\n\n";
	            maildata += "このたびは lastminute.com にご登録いただきありがとうございます。\n";
	            maildata += "以下のID・パスワードでご登録を受け付けました。\n\n";
	            maildata += "-----------------------------------------------------------\n";
	            maildata += "lastminute.com 会員ご登録内容\n";
	            maildata += "-----------------------------------------------------------\n";
	            maildata += "ID         :"+ e_mail +"\n";
	            maildata += "パスワード :" + passwd + "\n";
	            maildata += "-----------------------------------------------------------\n\n";
	            maildata += "今後のご利用をお待ち申し上げております。\n\n";
	            maildata += "---------------------------------------\n";
	            maildata += "do something lastminute.com\n";
	            maildata += "株式会社ラストミニット・ドット・コム\n";
	            maildata += "mailto: newsletter@lastminute.co.jp\n";
	            maildata += "URL: http://www.lastminute.co.jp\n";
	            maildata += "---------------------------------------\n";
	            mailsender.SendMail(e_mail,"customer@lastminute.co.jp","lastminute.com 会員登録完了のご連絡",maildata);
