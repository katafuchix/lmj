...
import jp.co.lastminute.Entertainment.jdbc.*;
...
public class FormAction extends Action{
	...
	throws IOException, ServletException
    {
    	...
    	//データベースから取得する
    	try{
	    	dbAdapterEntertainment db = new dbAdapterEntertainment( this.dss );
    ...
    private static String getXmlAmount( String filename ){
    	try{
    		String filepath = ContextProperty.basepath + ContextProperty._ticket_product_Dir;
