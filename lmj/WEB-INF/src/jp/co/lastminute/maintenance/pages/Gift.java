 ...
 */
public class Gift extends IndexPageMaker implements Serializable{

	public static int[][] pagemetrix = jp.co.lastminute.maintenance.gift.Property.pagemetrix;
	public static int[] page_types = jp.co.lastminute.maintenance.gift.Property.page_types;
	public static String[] page_type_names = jp.co.lastminute.maintenance.gift.Property.page_type_names;
	public static String page_paths = jp.co.lastminute.maintenance.gift.Property.page_paths + "/";
	public static String targetname = jp.co.lastminute.maintenance.gift.Property.targetname;
	private static int catid = jp.co.lastminute.maintenance.gift.Property.product_type_cd;
	...
	public static final String _windowsql = "SELECT "
 										...
 										+"C.FIRST_NAME "		//07
										+"FROM "
 										+"CALLEGEPRODUCT_TBL B, "
 										+ "(SELECT JAN_CD FROM SCATID_MARGE WHERE S_CATID=$1) A,"
 										+ "AGENT_TBL C "
 										+"WHERE A.JAN_CD=B.JAN_CD AND C.AGT_CD=B.AGT_CD "
